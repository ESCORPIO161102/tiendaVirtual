  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Nueva Area </h5>
            ...
            <div class="tile-body">
              <form id="formRol" name="formRol">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="2" placeholder="Descripción del area" required=""></textarea>
                </div>
                <div class="form-group">

<?php 
	...
	class accesorioProducto extends Controllers{
		...
		public function accesorioProducto()
		{
			...
			$data['page_title'] = "REGISTRO ACCESORIOS";
			$data['page_name'] = "Registro Productos";
			$data['page_functions_js'] = "functions_RegistroAccesorioProductos.js";
			$this->views->getView($this,"accesorioProducto",$data);
		}
		//funciones 
